    ...
    <div className='flex flex-col justify-center items-center min-h-[80vh] bg-gradient-to-b'>
      ...
      <div className='flex flex-row items-center gap-2 mt-8 mb-6 bg-white px-8 py-1 rounded-full shadow-sm'>
        <span className='flex -space-x-2'>
          <Image src="https://framerusercontent.com/images/0XIOoF2Oain1ymw3aK4KMS8VDE.png" alt="Reviewer avatar 1" width={32} height={32} className='w-8 h-8 rounded-full border-2 border-white object-cover'/>
          <Image src="https://framerusercontent.com/images/DxODa2XczEyPpL800pUZkXcDCY.png" alt="Reviewer avatar 2" width={32} height={32} className='w-8 h-8 rounded-full border-2 border-white object-cover'/>
          <Image src="https://framerusercontent.com/images/kK54VVzwxoCJrm6zaFFsJ9qWJNo.png" alt="Reviewer avatar 3" width={32} height={32} className='w-8 h-8 rounded-full border-2 border-white object-cover'/>
        </span>
        ...
        <div className="relative flex items-center justify-center w-full mt-2" style={{minHeight: '80px'}}>
          ...
          >
            ...
            <Image
              ...
              width={28}
              height={28}
              className="w-7 h-7 -ml-2 mb-10 object-contain"
            />
          </motion.div>
          ...
          >
            <Image
              ...
              width={28}
              height={28}
              className="w-7 h-7 -mr-2 mb-9 object-contain"
            />
